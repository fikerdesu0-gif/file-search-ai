...
const WashingMachineIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" viewBox="0 0 100 100">
        ...
        {/* Control Panel */}
        <rect x="20" y="15" width="25" height="10" rx="2" fill="#1e293b" fillOpacity="0.6"/>
        <rect x="50" y="15" width="30" height="10" rx="2" fill="#1e293b" fillOpacity="0.6"/>
        
        {/* Dials and buttons */}
        <circle cx="65" cy="20" r="3" fill="#94a3b8" />
        <circle cx="56" cy="20" r="1.5" fill="#94a3b8" />
        <circle cx="74" cy="20" r="1.5" fill="#94a3b8" />

        {/* Door */}
        <circle cx="50" cy="55" r="25" fill="#1e293b" />
        <circle cx="50" cy="55" r="22" fill="url(#washer-glass-gradient)" />
        <circle cx="50" cy="55" r="19" fill="#1e293b" opacity="0.3" />


        {/* Feet */}
        <rect x="20" y="95" width="10" height="3" rx="1" fill="#1e293b" />
        <rect x="70" y="95" width="10" height="3" rx="1" fill="#1e293b" />
    </svg>
);
